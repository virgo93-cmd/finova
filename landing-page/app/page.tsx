...
const downloadUrl = "/downloads/finova-android-v2.0.1.apk";
...
const indonesian: Record<string, string> = {
  ...
  "Version 2.0.1 · Android only · 67 MB": "Versi 2.0.1 · Khusus Android · 67 MB",
    ...
    <main className="site-shell">
      ...
      <section className="download-section container" id="download">
        <div className="download-card">
          ...
          <small>Version 2.0.1 · Android only · 67 MB</small>
        </div>
      </section>
